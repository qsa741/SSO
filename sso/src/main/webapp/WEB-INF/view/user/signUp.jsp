			...
			<div class="border">
				...
				<div class="item">
					...
					<input class="easyui-textbox" id="id" name="id"
						prompt="특수문자 제외 영문자 4글자 이상" tabindex="1">
				</div>
				<div class="item">
					<div class="row">
						<div class="row2">
					...
					<input class="easyui-passwordbox" iconWidth="28" id="pw" name="pw"
						prompt="영문, 숫자, 특수문자로 8글자 이상" tabindex="2">
				</div>
				<div class="item">
					<div class="row">
						<div class="row2">
				...
				<div class="item">
					...
					<input class="easyui-textbox" id="email" name="email"
						prompt="example@example.com" tabindex="4">
				</div>
				<div class="item">
					<div class="row">
						<div class="row2">
				...
				<div class="item">
					<div class="row">
						<div class="row2">
							<label>DB 비밀번호&nbsp;</label> <input type="button" id="dbTest"
				...
				<div class="signUp-btns">
					<input type="button" class="easyui-linkbutton" value="취소"
						...
						class="easyui-linkbutton" value="확인">
				</div>
			</div>
		</form>
	</div>
