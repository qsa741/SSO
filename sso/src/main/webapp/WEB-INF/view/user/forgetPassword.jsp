...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="/resources/user/css/forgetPassword.css">
</head>
<body>
	<div class="container">
		<div class="header">비밀번호 찾기</div>
		<form id="forgetPasswordForm" action="/users/sendMail" method="POST" onsubmit="return forgetPasswordSubmit()">
			<div class="border">
				<div class="item">
					<div class="row2">
						<label>아이디</label>
				...
				<div id="login-btns">
					<input class="easyui-linkbutton" type="button" onclick="window.location='/users/signIn'" value="취소"> 
					<input class="easyui-linkbutton" type="submit" value="확인">
				</div>
			</div>
		</form>
	</div>
